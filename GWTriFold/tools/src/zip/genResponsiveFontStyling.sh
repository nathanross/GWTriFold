...
#tested - no difference in behavior in cygwin.

#path to the gwt-user packages's /com/google/gwt/user/theme/ directory 

mkdir -p /tmp/gwt-user
mkdir -p "${1}/responsiveCSS/"
unzip -qq -n "$GWTHOME/gwt-user.jar" -d /tmp/gwt-user/
